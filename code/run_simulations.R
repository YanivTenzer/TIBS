  ...
  {
    for(num_of_observations in c(500))#seq(250, 400, 50))
    {
  ...
  ##jpeg(paste0("../figs/check_valid_n_", " _dep_", dependence.type[s], "_w_",  w.fun[s],  "_perturb_grid_", prms$perturb.grid, ".jpg"), width = 400, height = 400)
