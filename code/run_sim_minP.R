...
test.stat <- c("minP2") # possible test statistics # "hoeffding", , "tsai", "minP2" "adjusted_w_hoeffding", 
test.method <- c("minP2") # possible methods for computing the test statistic "fast-bootstrap", "bootstrap",  
IS.methods <- c("") #  different methods for importance sampling of permutations
...
if(isRStudio == 1)
{
  iterations = 5 # 500 # 00 # official: 500
  B = 99 # 1000 # 0 # official:  1000  
  sample.size = 100 #  official:  100
  run.dep <- c(2:7) #  official: 1:9 # c(8:num.sim) # 2 is only Gaussians (to compare to minP2 power) # 1 # Loop on different dependency types 
